...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.2]{boxplotLucro.png}
...
A volatilidade dessa variável, medida pelo desvio padrão ($\sigma$), foi de 6,1459, enquanto a variância ($\sigma^2$) foi de 37,7723, refletindo flutuações consideráveis no preço da ação ao longo dos 20 anos analisados. Além das medidas de dispersão, foram calculadas as principais medidas de tendência central, média ($\mu$), mediana ($\tilde{X}$), moda ($M_o$), as quais oferecem uma visão consolidada do comportamento de cada uma das variáveis.

A Tabela~\ref{tendencia-central} sintetiza as medidas de dispersão para as três variáveis quantitativas analisadas: Preço, Lucro e IBOVESPA. 
% ---
\begin{table}[H]
\IBGEtab{%
  ...
  Variável & $\sigma^2$ & $\sigma$ & $\mu$ & $\tilde{X}$ & $M_o$  \\
  \midrule \midrule
    Preço & 37,7723 & 6,1459 & 8,2031 & 5,6700 & {5,67} \\
	Lucro & 5,2904 & 2,3001 & 3,5215 & 2,9100 & {2,91; 7,45} \\
	IBOVESPA & 920158777,6872 & 30334,1190 & 69976,6071 & 61243,0000 & --- \\
  \bottomrule
\end{tabular}%
}{%
